const data = {
  Aptitude: [
    ...
    {
      id: 2,
      question: "If 5 pencils cost $1, how much would 15 pencils cost?",
      options: ["$2", "$3", "$4", "$5"],
      answer: "$3",
    },
    {
    ...
    },
    {
      id: 4,
      question:
        "If a clock shows the time as 3:00 PM, what is the angle between the hour and the minute hands?",
    ...
    },
    {
      ...
      options: ["90 degrees", "180 degrees", "360 degrees", "540 degrees"],
      answer: "180 degrees",
    },
    {
      id: 6,
      question:
        "If a train travels 60 miles in 1 hour, what is its speed in miles per hour?",
    ...
    },
    {
      id: 7,
      question:
        "A car travels 120 miles in 3 hours. What is its average speed?",
  ...
  Coding: [
    ...
    },
    {
      id: 8,
      question:
        "In Python, what is the symbol for the exponentiation operator?",
      options: ["^", "*", "**", "^^"],
      answer: "**",
    },
    {
  ...
  Interview: [
    ...
    },
    {
      ...
      options: [
        ...
        "I am a good fit for the team",
        "I have a positive attitude",
      ],
      answer: "I have the necessary skills",
    },
    {
      id: 3,
      ...
      options: [
        ...
        "By seeking help from colleagues",
        "By working longer hours",
      ],
      answer: "By prioritizing tasks",
    },
    {
      id: 4,
      ...
      answer: "A complex software application",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      options: [
        ...
        "By importance",
        "By difficulty",
        "By supervisor's instructions",
      ],
      answer: "By importance",
    },
    {
      id: 8,
      question: "Describe a time when you disagreed with a colleague.",
      options: [
      ...
      answer: "Resolved through discussion",
    },
    {
      id: 9,
